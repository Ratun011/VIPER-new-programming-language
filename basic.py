...
class Parser:
  ...
  def statement(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'RETURN', 'CONTINUE', 'BREAK', 'VAR', 'JODI', 'FOR', 'WHILE', 'FUN', int, float, identifier, '+', '-', '(', '[' or 'NOT'"
      ))
  ...
  def expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'VAR', 'JODI', 'FOR', 'WHILE', 'FUN', int, float, identifier, '+', '-', '(', '[' or 'NOT'"
      ))
  ...
  def comp_expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected int, float, identifier, '+', '-', '(', '[', 'JODI', 'FOR', 'WHILE', 'FUN' or 'NOT'"
      ))
  ...
  def atom(self):
    ...
    return res.failure(InvalidSyntaxError(
      ...
      "Expected int, float, identifier, '+', '-', '(', '[', JODI', 'FOR', 'WHILE', 'FUN'"
    ))
  ...
  def if_expr_b(self):
    return self.if_expr_cases('NAJODI')
    
  def if_expr_c(self):
    res = ParseResult()
    else_case = None

    if self.current_tok.matches(TT_KEYWORD, 'NAHOLEY'):
      res.register_advancement()
      self.advance()
  ...
  def if_expr_b_or_c(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'NAJODI'):
  ...
  def if_expr_cases(self, case_keyword):
    ...
    if not self.current_tok.matches(TT_KEYWORD, 'TAHOLEY'):
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        f"Expected 'TAHOLEY'"
      ))
...
global_symbol_table.set("LIKHI", BuiltInFunction.print)
global_symbol_table.set("LEKHO", BuiltInFunction.print_ln)
